...
const OnlineJudge = ({ problem, theme, onBack }) => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', height: '100%' }}>
      ...
      <div className="dashboard-card" style={{ padding: '1.5rem', flexShrink: 0 }}>
      ...
      {/* CARD 2: C Compiler Editor */}
      <div className="dashboard-card" style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: '400px', overflow: 'hidden' }}>
